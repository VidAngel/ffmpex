defmodule FFmpex.Options.Video.Libavformat do
  ...
  @known_options %{
    ...
    individual_header_trailer:   %Option{name: "-individual_header_trailer", require_arg: true, contexts: [:output]},
    ...
    segment_list:                %Option{name: "-segment_list", require_arg: true, contexts: [:output]},    
    segment_list_size:           %Option{name: "-segment_list_size", require_arg: true, contexts: [:output]},
    segment_list_type:           %Option{name: "-segment_list_type", require_arg: true, contexts: [:output]},
    segment_time:                %Option{name: "-segment_time", require_arg: true, contexts: [:output]},
    ...
    master_pl_name:              %Option{name: "-master_pl_name", require_arg: true, contexts: [:output, :input, :global]},
    cc_stream_map:               %Option{name: "-cc_stream_map", require_arg: true, contexts: [:output, :input, :global]},
